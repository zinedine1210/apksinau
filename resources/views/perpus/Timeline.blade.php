@extends('perpus.layouts.main')
                ...
                <div class="card-header fw-bold pt-4 pb-4 text-white display-6" style="background-color: #35495E;">
                  <div class="row justify-content-center">
                    ...
                    <div class="col-2 text-center">
                      <a href="" data-bs-toggle="modal" data-bs-target="#buatTimeline"><i class="fas fa-plus text-white"></i></a>
                    </div>
                  </div>
                </div>
                <div class="card-body">
                  <ul class="nav justify-content-center fw-bold">
                    <li class="nav-item">
                      <a class="nav-link aktif" aria-current="page" href="/Perpus/Timeline">Semua</a>
                    </li>
                    <li class="nav-item">
  ...
  <!-- modal tambahTimeline -->
  <div class="modal fade" id="buatTimeline" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl">
      <div class="modal-content">
        <div class="modal-header bg2">
          <h5 class="modal-title fw-bold display-6 text-white" id="staticBackdropLabel">Buat Postingan</h5>
          <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
        <div class="modal-body">
          <form action="/Perpus/Timeline" method="post" enctype="multipart/form-data">
            @csrf
            <label for="body" class="form-label fcu2 fw-bold">Mau Posting apa hari ini?</label>
            @error('body')
                <p class="text-danger">{{ $message }}</p>
            @enderror
            <div class="form-floating">
                <input id="body" type="hidden" name="body" onfocus required>
