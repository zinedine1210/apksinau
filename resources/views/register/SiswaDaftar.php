...
<head>
  ...
  <title>Sinau| Daftar Siswa</title>
...
<body class="u-body">
  <header class="u-clearfix u-header u-header" id="sec-8ee2">
    <div class="u-clearfix u-sheet u-sheet-1">
      <a href="/AsSiswa" data-page-id="50336443" class="u-image u-logo u-image-1" title="Portal" data-image-width="1076" data-image-height="915">
    ...
    <div class="u-clearfix u-sheet u-sheet-1">
      <div class="u-border-1 u-border-custom-color-2 u-container-style u-group u-radius-50 u-shape-round u-group-1">
        <div class="u-container-layout u-container-layout-1">
          <h3 class="u-align-center u-custom-font u-text u-text-default-lg u-text-default-md u-text-default-sm u-text-default-xl u-text-font u-text-1">Selamat Datang di E-School<br>Daftar Siswa
          </h3>
          ...
          <div class="u-expanded-width-lg u-expanded-width-md u-expanded-width-sm u-expanded-width-xl u-form u-login-control u-form-1">
            <form action="#" method="POST" class="u-clearfix u-form-custom-backend u-form-spacing-35 u-form-vertical u-inner-form" source="custom" name="form-2" style="padding: 10px;">
              ...
              <div class="u-form-group u-form-password">
                ...
                <input type="text" placeholder="Password" id="password-708d" name="password" class="u-grey-5 u-input u-input-rectangle" required="required">
              </div>
              <div class="u-form-group u-form-group-3">
                <label for="text-a2d2" class="u-form-control-hidden u-label"></label>
                <input type="text" placeholder="Tuliskan Kembali Password" id="text-a2d2" name="text" class="u-grey-5 u-input u-input-rectangle">
              </div>
              ...
              <div class="u-align-center u-form-group u-form-submit">
                <a href="#" class="u-border-none u-btn u-btn-round u-btn-submit u-button-style u-custom-color-2 u-hover-custom-color-3 u-radius-40 u-btn-1">Daftarkan</a>
